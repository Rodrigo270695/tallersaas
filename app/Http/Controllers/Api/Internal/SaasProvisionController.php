...
/**
 * Contrato interno server-to-server con Orvae PE. Ver `routes/api.php`
 * y {@see VerifyOrvaeProvisionSignature}.
 */
    ...
    public function provision(ProvisionTenantRequest $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'message' => app()->hasDebugModeEnabled() ? $e->getMessage() : 'No se pudo crear el taller.',
            ], 500);
        }
