...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('subscriptions', function (Blueprint $table) {
            ...
            $table->string('ciclo', 12)->default('mensual');
        ...
        if (Schema::getConnection()->getDriverName() === 'pgsql') {
            ...
            DB::statement("ALTER TABLE subscriptions ADD CONSTRAINT chk_subscriptions_ciclo CHECK (ciclo IN ('mensual','trimestral','semestral','anual'))");
