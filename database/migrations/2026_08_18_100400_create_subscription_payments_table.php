...
{
    /**
     * Pago de una suscripción al SaaS. La fila la genera Orvae cuando la
     * pasarela confirma el cobro: TallerSaaS no procesa pagos, solo los
     * registra para soporte (reembolso manual, nota interna, etc.).
     */
    public function up(): void
    {
        Schema::create('subscription_payments', function (Blueprint $table) {
            ...
            $table->timestampTz('invoice_resent_at')->nullable();
