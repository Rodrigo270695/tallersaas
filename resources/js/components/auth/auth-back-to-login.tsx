...
type AuthBackToLoginProps = {
    /** Si se omite, usa el texto por defecto. */
    label?: string;
    /**
 ...
 */
export default function AuthBackToLogin({ label, onClick }: AuthBackToLoginProps) {
    const resolvedLabel = label ?? 'Volver a iniciar sesión';
