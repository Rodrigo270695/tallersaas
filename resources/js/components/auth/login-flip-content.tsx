 ...
 */
export default function LoginFlipContent({ canResetPassword }: LoginFlipContentProps) {
        ...
        >
            ...
            <div
                className={cn(
                    ...
                    'shadow-[0_24px_70px_-18px_rgba(60,20,0,0.28),0_10px_28px_-14px_rgba(60,20,0,0.18),inset_0_1px_0_0_rgba(255,255,255,0.6)]',
            ...
            >
                ...
                >
                    ...
                    <rect width="100%" height="100%" filter={`url(#card-grain-${rotation})`} />
                </svg>
