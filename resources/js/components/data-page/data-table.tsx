...
/**
 * Tipo que pueden tener las claves de fila (UUID en string, BIGINT en number).
 */
...
export type DataTableProps<T> = {
     ...
     * (desktop) y un checkbox en cada card (mobile).
     */
    selection?: DataTableSelection<DataTableRowId>;
    /**
     * Si true, la tabla desktop usa `table-layout: fixed`.
     */
 ...
 *
 * - **Desktop (md+):** tabla clásica con encabezado.
