 ...
 * (evita que `/taller/ordenes-trabajo` quede activo en otra ruta no hija).
 */
...
export function useCurrentUrl(): UseCurrentUrlReturn {
    ...
    const isCurrentOrParentUrl: IsCurrentOrParentUrlFn = (
        ...
        // Solo hijo real: `/ordenes-trabajo` no coincide con `/ordenes-trabajo-bulk`,
        // pero sí con `/ordenes-trabajo/{id}`.
