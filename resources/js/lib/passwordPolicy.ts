...
export type PasswordRequirementId = 'length' | 'mixed' | 'number' | 'symbol';
...
const REQUIREMENT_TESTS: Record<PasswordRequirementId, (password: string) => boolean> = {
...
const REQUIREMENT_IDS = Object.keys(REQUIREMENT_TESTS) as PasswordRequirementId[];
