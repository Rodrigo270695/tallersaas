...
const tileStyles: Record<QuickActionItem['accent'], string> = {
    brand: 'border-brand-200/60 bg-brand-50/50 hover:border-brand-300/60 hover:bg-brand-50 dark:bg-brand-950/20 dark:hover:bg-brand-950/40',
...
export function DashboardQuickActions({ items }: { items: QuickActionItem[] }) {
    ...
    return (
        <Card className="min-w-0 border-border/80 py-0 shadow-sm">
            ...
            <CardContent className="grid gap-2 px-6 py-4">
                {items.map((item) => {
