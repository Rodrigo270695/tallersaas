        ...
        () => [
            ...
            },
            {
                ...
                cell: (row) => {
                    ...
                    return (
                        <span className={`tabular-nums font-medium ${n < 0 ? 'text-rose-700' : 'text-emerald-700'}`}>
                            {sign}
        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-5 p-4 sm:p-6">
                <PageHeader
                    ...
                    stats={[
                        { label: 'Total', value: stats.total, variant: 'info', icon: ArrowLeftRight },
                        {
                            label: 'Filtros',
                    ...
                    toolbar={
                        ...
                        >
                            <FilterChips
                                ...
                                value={filters.tipo}
                                onChange={(tipo) =>
                                    applyFilter({ tipo: tipo as MovimientoFilters['tipo'] })
                                }
                                options={tipoOptions}
                            />
                            {sedes.length > 0 && (
