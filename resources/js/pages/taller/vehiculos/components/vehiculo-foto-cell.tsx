...
export type VehiculoFotoCellProps = {
    fotoUrl: string | null;
    etiqueta: string;
};

/**
 * Miniatura de foto en la tabla de vehículos. Sin foto → placeholder;
 * con foto → click abre dialog con la imagen grande (como mascotas en VetSaaS).
 */
export function VehiculoFotoCell({ fotoUrl, etiqueta }: VehiculoFotoCellProps) {
    ...
    if (!fotoUrl) {
        return (
            <span
                ...
                title="Sin foto"
            >
                <Car className="size-4 opacity-60" aria-hidden />
                ...
                <DialogContent className="max-w-3xl sm:max-w-3xl">
                    <DialogHeader>
                        ...
                        <DialogDescription className="sr-only">
                            Vista ampliada de la foto del vehículo
                        </DialogDescription>
                    </DialogHeader>
